...
/* Here we define the SPARQL pattern which finds n3 rule files that correspond to the given topic URIs */ 
public static String getSparqlPatternRulesForTopic(String prefix, String topic) {
		...
		String sparqlPattern = "PREFIX prefix: <" + prefix + ">" + "\n" + 
				   ...
				   "?n3PartRule surgiProp:Has_topic prefix:" + topic + " ." + "\n" + 
				   "?n3PartRule surgiProp:Has_name ?n3Rule . " + "\n" +
				   "?n3Rule  surgiProp:Has_N3RuleFile ?n3RuleFile . }"; 
