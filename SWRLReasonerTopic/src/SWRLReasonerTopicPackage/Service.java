...
public class Service {
	        ...
	        if (solutions.isEmpty()) 
				...
				// go through all rules found by topic
	          	for (ListIterator<QuerySolution> it = solutions.listIterator(); it.hasNext();) {
					...
					/* Note: the patient ontology and the rule ontology have the same basic IRI. 
	...
	public String getServiceDescriptionRDFXML(@Context final HttpServletResponse response, @Context final ServletContext context) throws Exception {
		...
		ServiceHelper.printRDFDescriptionFromFile(descriptionsPath + "SWRLReasonerTopic_description.xml", response, context, "application/rdf+xml");
